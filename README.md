...
| [Продажа квартир в Санкт-Петербурге — анализ рынка недвижимости](apartments) | 1.Изучить информацию о пропусках ;2. Заменить пропущенные значения, где это возможно;3.Изучить типы данных представленные нам в таблице;4.Найти и устранить выбивающиеся значения;5.Посчитать и добавить в таблицу новые данные;6. Провести исследовательский анализ данных;7.Изучить, как быстро или как долго продавались квартиры;8. существование корреляционных зависимостей, влияющих на продажи.| *pandas*, *math*, *matplotlib.pyplot*, *numpy* |аааааааа| 
